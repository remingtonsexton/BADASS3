...
# --------------------------------------------------------------------------------------------------
#
fit_options = {'fit_reg': (1000, 3500), 'good_thresh': 0.0, 'mask_bad_pix': False, 'mask_emline': False, 'mask_metal': True, 'fit_stat': 'RCHI2', 'n_basinhop': 25, 'test_lines': False, 'max_like_niter': 0, 'output_pars': False, 'cosmology': {'H0': 70.0, 'Om0': 0.3}}
#
