...
"""Bayesian AGN Decomposition Analysis for SDSS Spectra (BADASS3), Version 7.7.6, Python 3.8 Version
...
def outflow_test_plot_oiii(comp_dict_outflow,comp_dict_no_outflow,run_dir):
	...
	ax1.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['host_galaxy']['comp']     , color='xkcd:lime green' , linewidth=1.0, linestyle='-' , label='Host Galaxy'       )
	...
	if ('na_feii_template' in comp_dict_no_outflow) and ('br_feii_template' in comp_dict_no_outflow):
		ax1.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['na_feii_template']['comp'], color='xkcd:yellow'     , linewidth=1.0, linestyle='-' , label='Narrow FeII'     )
		ax1.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['br_feii_template']['comp'], color='xkcd:orange'     , linewidth=1.0, linestyle='-' , label='Broad FeII'     )
		...
		ax1.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['S_feii_template']['comp'], color='xkcd:mustard'     , linewidth=1.0, linestyle='-' , label='S-transition FeII'     )
		ax1.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['G_feii_template']['comp'], color='xkcd:orange'     , linewidth=1.0, linestyle='-' , label='G-transition FeII'     )
		ax1.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['Z_feii_template']['comp'], color='xkcd:rust'     , linewidth=1.0, linestyle='-' , label='Z-transition FeII'     )
	if ('br_Hb' in comp_dict_no_outflow):
		ax1.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['br_Hb']['comp']           , color='xkcd:turquoise'  , linewidth=1.0, linestyle='-' , label=r'Broad H$\beta$'       )
	...
	ax1.set_xticks([4400,4500,4600,4700,4800,4900,5000,5100,5200,5300,5400,5500])
	...
	ax2.plot(comp_dict_no_outflow['wave']['comp'],(comp_dict_no_outflow['data']['comp']-comp_dict_no_outflow['model']['comp']), color='xkcd:white' , linewidth=0.5, linestyle='-')
	...
	ax2.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['noise']['comp'], color='xkcd:bright aqua' , linewidth=0.5, linestyle='-')
	...
	ax2.set_xticks([4400,4500,4600,4700,4800,4900,5000,5100,5200,5300,5400,5500])
	margin = 0.50
	ax2.margins(x=0.0,y=margin)
	...
	ax3.plot(comp_dict_outflow['wave']['comp'], comp_dict_outflow['host_galaxy']['comp']        , color='xkcd:lime green' , linewidth=1.0, linestyle='-' , label='Host Galaxy'       )
	...
	if ('na_feii_template' in comp_dict_outflow) and ('br_feii_template' in comp_dict_outflow):
		ax3.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['na_feii_template']['comp'], color='xkcd:yellow'     , linewidth=1.0, linestyle='-' , label='Narrow FeII'     )
		ax3.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['br_feii_template']['comp'], color='xkcd:orange'     , linewidth=1.0, linestyle='-' , label='Broad FeII'     )
		...
		ax3.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['S_feii_template']['comp'], color='xkcd:mustard'     , linewidth=1.0, linestyle='-' , label='S-transition FeII'     )
		ax3.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['G_feii_template']['comp'], color='xkcd:orange'     , linewidth=1.0, linestyle='-' , label='G-transition FeII'     )
		ax3.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['Z_feii_template']['comp'], color='xkcd:rust'     , linewidth=1.0, linestyle='-' , label='Z-transition FeII'     )
	if ('br_Hb' in comp_dict_outflow):
		ax3.plot(comp_dict_outflow['wave']['comp'], comp_dict_outflow['br_Hb']['comp']              , color='xkcd:turquoise'  , linewidth=1.0, linestyle='-' , label=r'Broad H$\beta$'       )
	...
	ax3.set_xticks([4400,4500,4600,4700,4800,4900,5000,5100,5200,5300,5400,5500])
	ax3.set_ylim(0.0,np.max(comp_dict_outflow['model']['comp'])+3*np.median(comp_dict_outflow['noise']['comp']))
	ax3.set_title('Outflow Model')
	# Outflow Residuals
	ax4.plot(comp_dict_outflow['wave']['comp'], (comp_dict_outflow['data']['comp']-comp_dict_outflow['model']['comp']), color='xkcd:white' , linewidth=0.5, linestyle='-')
	...
	ax4.plot(comp_dict_outflow['wave']['comp'], comp_dict_outflow['noise']['comp'], color='xkcd:bright aqua' , linewidth=0.5, linestyle='-')
	...
	ax4.set_xticks([4400,4500,4600,4700,4800,4900,5000,5100,5200,5300,5400,5500])
	margin = 0.50
	ax4.margins(x=0.0,y=margin)
...
def outflow_test_plot_nii(comp_dict_outflow,comp_dict_no_outflow,run_dir):
	...
	if ('br_Ha' in comp_dict_no_outflow):
		ax1.plot(comp_dict_no_outflow['wave']['comp'], comp_dict_no_outflow['br_Ha']['comp']             , color='xkcd:turquoise'  , linewidth=1.0, linestyle='-' , label=r'Broad H$\alpha$'      )
	...
	if ('br_Ha' in comp_dict_outflow):
		ax3.plot(comp_dict_outflow['wave']['comp'], comp_dict_outflow['br_Ha']['comp']             , color='xkcd:turquoise'  , linewidth=1.0, linestyle='-' , label=r'Broad H$\alpha$'      )
	...
	if ((test_outflows==True) ):
		...
		if 1:
			...
			for key in comp_dict:
				...
				if (key != 'resid') and (key != 'noise') and (key != 'wave') and (key != 'data'):
			...
			ax2.plot(lam_gal,(comp_dict['noise']['comp']),linewidth=comp_dict['noise']['linewidth'],color=comp_dict['noise']['pcolor'],label='$\sigma_{\mathrm{noise}}=%0.4f$' % (sigma_noise))
			ax2.plot(lam_gal,(comp_dict['resid']['comp']),linewidth=comp_dict['resid']['linewidth'],color=comp_dict['resid']['pcolor'],label='$\sigma_{\mathrm{resid}}=%0.4f$' % (sigma_resid))
...
def plot_best_model(param_dict,lam_gal,galaxy,noise,gal_temp,feii_tab,feii_options,
	...
	sigma_noise = np.median(comp_dict['noise']['comp'])
	ax1.set_xlim(np.min(lam_gal)-10,np.max(lam_gal)+10)
	ax1.set_ylim(0-sigma_resid,np.max(comp_dict['data']['comp'])+sigma_resid)
	ax1.set_ylabel(r'$f_\lambda$ ($10^{-17}$ erg cm$^{-2}$ s$^{-1}$ $\mathrm{\AA}^{-1}$)',fontsize=12)
